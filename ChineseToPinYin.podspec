#
#  Be sure to run `pod spec lint ChineseToPinYin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of ChineseToPinYin in Markdown format.
  ...
  s.source       = { :git => "https://github.com/yyn1110/ChineseToPinYin.git", :tag => "0.0.1" }
